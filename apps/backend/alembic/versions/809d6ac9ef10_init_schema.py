...
def upgrade() -> None:
    ...
    op.add_column('edges', sa.Column('id', sa.UUID(), nullable=False))
    op.add_column('edges', sa.Column('a_entity_id', sa.UUID(), nullable=False))
    op.add_column('edges', sa.Column('b_entity_id', sa.UUID(), nullable=False))
    op.add_column('edges', sa.Column('label', sa.Text(), nullable=True))
    op.add_column('edges', sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
    op.create_unique_constraint('uq_edge_pair', 'edges', ['a_entity_id', 'b_entity_id'])
    op.create_foreign_key(None, 'edges', 'entities', ['b_entity_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'edges', 'entities', ['a_entity_id'], ['id'], ondelete='CASCADE')
    op.drop_column('edges', 'zipr')
    op.drop_column('edges', 'fullname')
    op.drop_column('edges', 'tlid')
    op.drop_column('edges', 'the_geom')
    op.drop_column('edges', 'tnidt')
    op.drop_column('edges', 'roadflg')
    op.drop_column('edges', 'deckedroad')
    op.drop_column('edges', 'countyfp')
    op.drop_column('edges', 'smid')
    op.drop_column('edges', 'tfidr')
    op.drop_column('edges', 'persist')
    op.drop_column('edges', 'tnidf')
    op.drop_column('edges', 'passflg')
    op.drop_column('edges', 'statefp')
    op.drop_column('edges', 'ttyp')
    op.drop_column('edges', 'gid')
    op.drop_column('edges', 'artpath')
    op.drop_column('edges', 'hydroflg')
    op.drop_column('edges', 'gcseflg')
    op.drop_column('edges', 'railflg')
    op.drop_column('edges', 'offsetr')
    op.drop_column('edges', 'lfromadd')
    op.drop_column('edges', 'divroad')
    op.drop_column('edges', 'rtoadd')
    op.drop_column('edges', 'olfflg')
    op.drop_column('edges', 'zipl')
    op.drop_column('edges', 'featcat')
    op.drop_column('edges', 'rfromadd')
    op.drop_column('edges', 'tfidl')
    op.drop_column('edges', 'ltoadd')
    op.drop_column('edges', 'exttyp')
    op.drop_column('edges', 'mtfcc')
    op.drop_column('edges', 'offsetl')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('edges', sa.Column('offsetl', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('mtfcc', sa.VARCHAR(length=5), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('exttyp', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('ltoadd', sa.VARCHAR(length=12), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('tfidl', sa.NUMERIC(precision=10, scale=0), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('rfromadd', sa.VARCHAR(length=12), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('featcat', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('zipl', sa.VARCHAR(length=5), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('olfflg', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('rtoadd', sa.VARCHAR(length=12), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('divroad', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('lfromadd', sa.VARCHAR(length=12), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('offsetr', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('railflg', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('gcseflg', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('hydroflg', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('artpath', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('gid', sa.INTEGER(), autoincrement=True, nullable=False))
    op.add_column('edges', sa.Column('ttyp', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('statefp', sa.VARCHAR(length=2), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('passflg', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('tnidf', sa.NUMERIC(precision=10, scale=0), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('persist', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('tfidr', sa.NUMERIC(precision=10, scale=0), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('smid', sa.VARCHAR(length=22), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('countyfp', sa.VARCHAR(length=3), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('deckedroad', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('roadflg', sa.VARCHAR(length=1), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('tnidt', sa.NUMERIC(precision=10, scale=0), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('the_geom', sa.NullType(), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('tlid', sa.BIGINT(), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('fullname', sa.VARCHAR(length=100), autoincrement=False, nullable=True))
    op.add_column('edges', sa.Column('zipr', sa.VARCHAR(length=5), autoincrement=False, nullable=True))
    ...
    op.drop_column('edges', 'b_entity_id')
    op.drop_column('edges', 'a_entity_id')
    op.drop_column('edges', 'id')
